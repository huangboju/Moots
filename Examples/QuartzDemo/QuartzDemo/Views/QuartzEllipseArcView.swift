...
class QuartzEllipseArcView: QuartzView {
    ...
    override func draw(in context: CGContext) {
        ...
        context.addArc(center: CGPoint(x: 150, y: 60), radius: 30.0, startAngle: 0, endAngle: .pi / 2, clockwise: false)
        context.strokePath()
        context.setStrokeColor(UIColor.yellow.cgColor)
        context.addArc(center: CGPoint(x: 150, y: 60), radius: 30.0, startAngle: 3.0 * .pi / 2.0, endAngle: .pi, clockwise: true)
        context.strokePath()

        // Stroke 2 arcs together going opposite directions.
        context.addArc(center: CGPoint(x: 150, y: 150), radius: 30, startAngle: 0, endAngle: .pi / 2.0, clockwise: false)
        context.addArc(center: CGPoint(x: 150, y: 150), radius: 30, startAngle: 3.0 * .pi / 2.0, endAngle: .pi, clockwise: true)
        context.strokePath()

        // Stroke 2 arcs together going the same direction..
        context.addArc(center: CGPoint(x: 150, y: 240), radius: 30, startAngle: 0, endAngle: .pi / 2.0, clockwise: false)
        context.addArc(center: CGPoint(x: 150, y: 240), radius: 30, startAngle: .pi, endAngle: 3.0 * .pi / 2.0, clockwise: false)
        context.strokePath()
        ...
        context.move(to: p[0])
        context.addArc(tangent1End: p[1], tangent2End: p[2], radius: 30)
        context.strokePath()
