...
class ZoomDismissalInteractionController: NSObject {
    ...
    func didPan(with gestureRecognizer: UIPanGestureRecognizer) {
        ...
        let backgroundAlpha = self.backgroundAlpha(for: fromVC.view, withPanningVerticalDelta: verticalDelta)
        let scale = self.scale(for: fromVC.view, withPanningVerticalDelta: verticalDelta)
    ...
    func backgroundAlpha(for view: UIView, withPanningVerticalDelta verticalDelta: CGFloat) -> CGFloat {
