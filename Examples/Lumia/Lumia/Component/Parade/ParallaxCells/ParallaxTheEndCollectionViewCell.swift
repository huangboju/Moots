...
class ParallaxTheEndCollectionViewCell: UICollectionViewCell {
    ...
    func setupInterface()
    {
        ...
        attributes[.font] = UIFont(descriptor: font!.fontDescriptor.withSymbolicTraits(.traitBold)!, size: font!.pointSize)
        attributes[.kern] =  (font!.pointSize * 200 / CGFloat(1000.0) as AnyObject?)
