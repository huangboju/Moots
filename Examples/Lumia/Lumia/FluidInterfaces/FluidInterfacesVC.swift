...
class FluidInterfacesVC: UIViewController {
    ...
    var rows: [RowType] = [
        Row<FluidInterfacesCell>(viewData: Interface(name: "Calculator button", icon: #imageLiteral(resourceName: "icon_calc"), color: UIColor(hex: 0x999999))),
        Row<FluidInterfacesCell>(viewData: Interface(name: "Spring animations", icon: #imageLiteral(resourceName: "icon_spring"), color: UIColor(hex: 0x64CCF7))),
        Row<FluidInterfacesCell>(viewData: Interface(name: "Flashlight button", icon: #imageLiteral(resourceName: "icon_flash"), color: UIColor(hex: 0xEDEDED))),
        Row<FluidInterfacesCell>(viewData: Interface(name: "Rubberbanding", icon: #imageLiteral(resourceName: "icon_rubber"), color: UIColor(hex: 0xFF5B50))),
        Row<FluidInterfacesCell>(viewData: Interface(name: "Acceleration pausing", icon: #imageLiteral(resourceName: "icon_acceleration"), color: UIColor(hex: 0x64FF8F))),
        Row<FluidInterfacesCell>(viewData: Interface(name: "Rewarding momentum", icon: #imageLiteral(resourceName: "icon_momentum"), color: UIColor(hex: 0x73B2FF))),
        Row<FluidInterfacesCell>(viewData: Interface(name: "FaceTime PiP", icon: #imageLiteral(resourceName: "icon_pip"), color: UIColor(hex: 0xF2F23A))),
        Row<FluidInterfacesCell>(viewData: Interface(name: "Rotation", icon: #imageLiteral(resourceName: "icon_rotation"), color: UIColor(hex: 0xFF28A5)))
