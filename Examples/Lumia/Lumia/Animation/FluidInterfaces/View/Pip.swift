...
class PipInterfaceViewController: InterfaceViewController {
    ...
    override func viewDidLoad() {
        ...
        topLeftView.topAnchor.constraint(equalTo: view.safeTopAnchor, constant: verticalSpacing).isActive = true
        ...
        topRightView.topAnchor.constraint(equalTo: view.safeTopAnchor, constant: verticalSpacing).isActive = true
        ...
        bottomLeftView.bottomAnchor.constraint(equalTo: view.safeBottomAnchor, constant: -verticalSpacing).isActive = true
        ...
        bottomRightView.bottomAnchor.constraint(equalTo: view.safeBottomAnchor, constant: -verticalSpacing).isActive = true
