...
extension UIScrollView {
    ...
    func parallaxHeaderView(view: UIView, mode: VGParallaxHeaderMode, height: CGFloat, shadowBehaviour _: VGParallaxHeaderShadowBehaviour) {
...
class VGParallaxHeader: UIView {
    ...
    override func observeValueForKeyPath(keyPath: String?, ofObject _: AnyObject?, change: [String: AnyObject]?, context _: UnsafeMutablePointer<Void>) {
